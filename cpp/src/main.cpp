...
// Function to URL encode the query parameters
...
string sendHttpRequest(const string& url, const string& data = "", const string& method = "GET") {
    ...
    if (curl) {
        ...
        if (res != CURLE_OK) {
            // Suppress the specific URL error
            ...
            case 3: {
                ...
                switch (searchType) {
                    case 1:
                        ...
                        getline(cin, title);
                        response = sendHttpRequest("http://localhost:3000/api/books?title=" + urlEncode(title));
                        break;
                    case 2:
                        cout << "\nEnter Book Author to find: ";
                        getline(cin, author);
                        response = sendHttpRequest("http://localhost:3000/api/books?author=" + urlEncode(author));
                        break;
                    case 3:
